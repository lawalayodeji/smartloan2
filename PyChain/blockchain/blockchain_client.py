...
class Blockchain:
    def __init__(self):
        ...
        # Genesis block
        if self.fetch_last_block()[0] is not None:
            self.chain = self.storageBlocks()
        else:
