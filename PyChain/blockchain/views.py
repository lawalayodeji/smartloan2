...
def transactions_index(request):
    ...
    template = 'blockchain/transactions_index.html'
    context = {}
...
def transactions_destined_for_next_block(request):
    ...
    template = 'blockchain/transactions_destined_for_next_block.html'
    context = {}
...
def transaction_auth_user(request):
    ...
    """
    user = request.user
    template = 'blockchain/initiate_transaction.html'
...
def block_detail(request, index):
    ...
    template = 'blockchain/block_detail.html'
    context = {}
    number = int(index)-1
...
def register_nodes(request):
    """Register new nodes"""
    template = 'blockchain/node_register.html'
...
def node_index(request):
    template = 'blockchain/node_index.html'
    context = {}
    context['nodes'] = BLOCKCHAIN.nodes
    return render(request, template, context)

def consensus(request):
    template = 'blockchain/nodes_resolve.html'
    context = {}
